...
// stores/layerPropStore.ts
var useLayerPropStore = defineStore("layerPropStore", () => {
  const isPanelVisible = ref(false);
  const selectedFeature = ref(null);
  const isPanelLoading = ref(false);
  const showPanel = /* @__PURE__ */ __name((feature) => {
    selectedFeature.value = feature;
    isPanelVisible.value = true;
    isPanelLoading.value = false;
  }, "showPanel");
  const hidePanel = /* @__PURE__ */ __name(() => {
    isPanelVisible.value = false;
    selectedFeature.value = null;
    isPanelLoading.value = false;
  }, "hidePanel");
  const setPanelLoading = /* @__PURE__ */ __name((loading) => {
    isPanelLoading.value = loading;
  }, "setPanelLoading");
  return {
    isPanelVisible,
    selectedFeature,
